...
// BEGIN TABLES
// Album TABLE
class TableAlbum extends Sqlite3EntityTableBase {
  TableAlbum() {
...
// Artist TABLE
class TableArtist extends Sqlite3EntityTableBase {
  TableArtist() {
    // declare properties of EntityTable
    tableName = 'Artist';
    ...
    // declare fields
    fields = [
      Sqlite3EntityFieldBase('Name', DbType.text),
    ];
    super.init();
  }
  static Sqlite3EntityTableBase? _instance;
...
// Customer TABLE
class TableCustomer extends Sqlite3EntityTableBase {
  TableCustomer() {
    // declare properties of EntityTable
    tableName = 'Customer';
    ...
    // declare fields
    fields = [
      Sqlite3EntityFieldBase('FirstName', DbType.text),
      Sqlite3EntityFieldBase('LastName', DbType.text),
      Sqlite3EntityFieldBase('Company', DbType.text),
      Sqlite3EntityFieldBase('Address', DbType.text),
      Sqlite3EntityFieldBase('City', DbType.text),
      Sqlite3EntityFieldBase('State', DbType.text),
      Sqlite3EntityFieldBase('Country', DbType.text),
      Sqlite3EntityFieldBase('PostalCode', DbType.text),
      Sqlite3EntityFieldBase('Phone', DbType.text),
      Sqlite3EntityFieldBase('Fax', DbType.text),
      Sqlite3EntityFieldBase('Email', DbType.text),
      Sqlite3EntityFieldRelationshipBase(
...
// Employee TABLE
class TableEmployee extends Sqlite3EntityTableBase {
  TableEmployee() {
    // declare properties of EntityTable
    tableName = 'Employee';
    ...
    fields = [
      ...
      Sqlite3EntityFieldBase('FirstName', DbType.text),
      Sqlite3EntityFieldBase('Title', DbType.text),
      Sqlite3EntityFieldBase('BirthDate', DbType.datetime,
          minValue: DateTime.parse('1900-01-01')),
      Sqlite3EntityFieldBase('HireDate', DbType.datetime,
          minValue: DateTime.parse('1900-01-01')),
      Sqlite3EntityFieldBase('Address', DbType.text),
      Sqlite3EntityFieldBase('City', DbType.text),
      Sqlite3EntityFieldBase('State', DbType.text),
      ...
      Sqlite3EntityFieldBase('Fax', DbType.text),
      Sqlite3EntityFieldBase('Email', DbType.text),
      Sqlite3EntityFieldRelationshipBase(null, DeleteRule.NO_ACTION,
...
// Genre TABLE
class TableGenre extends Sqlite3EntityTableBase {
  TableGenre() {
    // declare properties of EntityTable
    tableName = 'Genre';
...
// Invoice TABLE
class TableInvoice extends Sqlite3EntityTableBase {
  TableInvoice() {
    // declare properties of EntityTable
    tableName = 'Invoice';
    ...
    // declare fields
    fields = [
      Sqlite3EntityFieldBase('InvoiceDate', DbType.datetime,
          minValue: DateTime.parse('1900-01-01')),
      Sqlite3EntityFieldBase('BillingAddress', DbType.text),
      Sqlite3EntityFieldBase('BillingCity', DbType.text),
      Sqlite3EntityFieldBase('BillingState', DbType.text),
      Sqlite3EntityFieldBase('BillingCountry', DbType.text),
      Sqlite3EntityFieldBase('BillingPostalCode', DbType.text),
      Sqlite3EntityFieldBase('Total', DbType.real),
      Sqlite3EntityFieldRelationshipBase(
...
// InvoiceLine TABLE
class TableInvoiceLine extends Sqlite3EntityTableBase {
  TableInvoiceLine() {
    // declare properties of EntityTable
    ...
    // declare fields
    fields = [
      Sqlite3EntityFieldBase('UnitPrice', DbType.real),
      Sqlite3EntityFieldBase('Quantity', DbType.integer),
      Sqlite3EntityFieldRelationshipBase(
...
// MediaType TABLE
class TableMediaType extends Sqlite3EntityTableBase {
  TableMediaType() {
    // declare properties of EntityTable
    tableName = 'MediaType';
...
// Playlist TABLE
class TablePlaylist extends Sqlite3EntityTableBase {
  TablePlaylist() {
    // declare properties of EntityTable
    tableName = 'Playlist';
...
// Track TABLE
class TableTrack extends Sqlite3EntityTableBase {
  TableTrack() {
    // declare properties of EntityTable
    tableName = 'Track';
    ...
    fields = [
      Sqlite3EntityFieldBase('Name', DbType.text),
      Sqlite3EntityFieldBase('Composer', DbType.text),
      Sqlite3EntityFieldBase('Milliseconds', DbType.integer),
      Sqlite3EntityFieldBase('Bytes', DbType.integer),
      Sqlite3EntityFieldBase('UnitPrice', DbType.real),
      Sqlite3EntityFieldRelationshipBase(
...
// VTrack TABLE
class TableVTrack extends Sqlite3EntityTableBase {
  TableVTrack() {
    // declare properties of EntityTable
    tableName = 'VTracks';
    ...
    fields = [
      Sqlite3EntityFieldBase('Name', DbType.text),
      Sqlite3EntityFieldBase('album', DbType.text),
      Sqlite3EntityFieldBase('media', DbType.text),
      Sqlite3EntityFieldBase('genres', DbType.text),
      Sqlite3EntityFieldRelationshipBase(
          TableTrack.getInstance, DeleteRule.NO_ACTION,
          relationType: RelationType.ONE_TO_MANY, fieldName: 'TrackId'),
    ];
...
// PlaylistTrack TABLE
class TablePlaylistTrack extends Sqlite3EntityTableBase {
  TablePlaylistTrack() {
    // declare properties of EntityTable
...
class Chinookdb extends Sqlite3EntityModelProvider {
  Chinookdb() {
...
// END COLLECTIONS (Album)
  ...
  Future<int?> saveOrThrow({bool ignoreBatch = true}) async {
    if (AlbumId == null || AlbumId == 0) {
      ...
      // AlbumId= await _upsert(); // removed in sqlite3_entity_gen 1.3.0+6
...
//region AlbumManager
class AlbumManager extends Sqlite3EntityProvider {
  AlbumManager()
      : super(Chinookdb(),
...
// END COLLECTIONS (Artist)
  ...
  Future<int?> saveOrThrow({bool ignoreBatch = true}) async {
    if (ArtistId == null || ArtistId == 0) {
      ...
      // ArtistId= await _upsert(); // removed in sqlite3_entity_gen 1.3.0+6
...
class ArtistManager extends Sqlite3EntityProvider {
  ArtistManager()
      : super(Chinookdb(),
            tableName: _tableName,
            primaryKeyList: _primaryKeyList,
...
// END COLLECTIONS (Customer)
  ...
  Future<int?> saveOrThrow({bool ignoreBatch = true}) async {
    if (CustomerId == null || CustomerId == 0) {
      ...
      // CustomerId= await _upsert(); // removed in sqlite3_entity_gen 1.3.0+6
...
class CustomerManager extends Sqlite3EntityProvider {
  CustomerManager()
      : super(Chinookdb(),
            tableName: _tableName,
            primaryKeyList: _primaryKeyList,
...
// END COLLECTIONS (Employee)
  ...
  Future<int?> saveOrThrow({bool ignoreBatch = true}) async {
    if (EmployeeId == null || EmployeeId == 0) {
      ...
      // EmployeeId= await _upsert(); // removed in sqlite3_entity_gen 1.3.0+6
...
class EmployeeManager extends Sqlite3EntityProvider {
  EmployeeManager()
      : super(Chinookdb(),
            tableName: _tableName,
            primaryKeyList: _primaryKeyList,
...
// END COLLECTIONS (Genre)
  ...
  Future<int?> saveOrThrow({bool ignoreBatch = true}) async {
    if (GenreId == null || GenreId == 0) {
      ...
      // GenreId= await _upsert(); // removed in sqlite3_entity_gen 1.3.0+6
...
//region GenreManager
class GenreManager extends Sqlite3EntityProvider {
  GenreManager()
      : super(Chinookdb(),
            tableName: _tableName,
            primaryKeyList: _primaryKeyList,
...
// END COLLECTIONS (Invoice)
  ...
  Future<int?> saveOrThrow({bool ignoreBatch = true}) async {
    if (InvoiceId == null || InvoiceId == 0) {
      ...
      // InvoiceId= await _upsert(); // removed in sqlite3_entity_gen 1.3.0+6
...
class InvoiceManager extends Sqlite3EntityProvider {
  InvoiceManager()
      : super(Chinookdb(),
            tableName: _tableName,
            primaryKeyList: _primaryKeyList,
...
// RELATIONSHIPS (InvoiceLine)
  ...
  Future<int?> saveOrThrow({bool ignoreBatch = true}) async {
    if (InvoiceLineId == null || InvoiceLineId == 0) {
      ...
      // InvoiceLineId= await _upsert(); // removed in sqlite3_entity_gen 1.3.0+6
...
class InvoiceLineManager extends Sqlite3EntityProvider {
  InvoiceLineManager()
      : super(Chinookdb(),
            tableName: _tableName,
            primaryKeyList: _primaryKeyList,
...
// END COLLECTIONS (MediaType)
  ...
  Future<int?> saveOrThrow({bool ignoreBatch = true}) async {
    if (MediaTypeId == null || MediaTypeId == 0) {
      ...
      // MediaTypeId= await _upsert(); // removed in sqlite3_entity_gen 1.3.0+6
...
class MediaTypeManager extends Sqlite3EntityProvider {
  MediaTypeManager()
      : super(Chinookdb(),
            tableName: _tableName,
            primaryKeyList: _primaryKeyList,
...
// END COLLECTIONS (Playlist)
  ...
  Future<int?> saveOrThrow({bool ignoreBatch = true}) async {
    if (PlaylistId == null || PlaylistId == 0) {
      ...
      // PlaylistId= await _upsert(); // removed in sqlite3_entity_gen 1.3.0+6
...
class PlaylistManager extends Sqlite3EntityProvider {
  PlaylistManager()
      : super(Chinookdb(),
            tableName: _tableName,
            primaryKeyList: _primaryKeyList,
...
// END COLLECTIONS (Track)
  ...
  Future<int?> saveOrThrow({bool ignoreBatch = true}) async {
    if (TrackId == null || TrackId == 0) {
      ...
      // TrackId= await _upsert(); // removed in sqlite3_entity_gen 1.3.0+6
...
//region TrackManager
class TrackManager extends Sqlite3EntityProvider {
  TrackManager()
      : super(Chinookdb(),
            tableName: _tableName,
            primaryKeyList: _primaryKeyList,
...
class VTrackManager extends Sqlite3EntityProvider {
  VTrackManager()
      : super(Chinookdb(),
            tableName: _tableName,
            primaryKeyList: _primaryKeyList,
...
class PlaylistTrackManager extends Sqlite3EntityProvider {
...
class ChinookdbSequenceManager extends Sqlite3EntityProvider {

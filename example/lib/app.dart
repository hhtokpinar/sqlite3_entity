...
class HomeState extends State<Home> {
  ...
  void select(int value) async {
    switch (value) {
      case 0:
        showPopup(context, _aboutSqlite3Entity(), 'About Sqlite3Entity');
        break;
      case 1:
        final String modelString = await createSqlite3EntityModelString(false);
          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                Flexible(
                    child: Text(
                        'Sqlite3Entity ORM for Flutter/Dart lets you build and execute SQL commands easily and quickly with the help of fluent methods similar to .Net Entity Framework.')),
              ],
            ),
            SizedBox(
              height: 20,

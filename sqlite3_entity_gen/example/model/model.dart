...
// BEGIN TABLES
// Product TABLE
class TableProduct extends Sqlite3EntityTableBase {
  TableProduct() {
    ...
    // declare fields
    fields = [
      Sqlite3EntityFieldBase('name', DbType.text, isNotNull: true),
      Sqlite3EntityFieldBase('description', DbType.text),
      Sqlite3EntityFieldBase('price', DbType.real, defaultValue: 0),
      Sqlite3EntityFieldBase('isActive', DbType.bool, defaultValue: true),
      Sqlite3EntityFieldRelationshipBase(
          TableCategory.getInstance, DeleteRule.CASCADE,
          relationType: RelationType.ONE_TO_MANY,
          fieldName: 'categoryId',
          defaultValue: 1),
      Sqlite3EntityFieldBase('rownum', DbType.integer),
      Sqlite3EntityFieldBase('imageUrl', DbType.text),
      Sqlite3EntityFieldBase('datetime', DbType.datetime,
          defaultValue: DateTime.now(),
          isNotNull: true,
          minValue: DateTime.parse('2019-01-01'),
          maxValue: DateTime.now().add(Duration(days: 30))),
      Sqlite3EntityFieldBase('date', DbType.date,
          minValue: DateTime.parse('2015-01-01'),
          maxValue: DateTime.now().add(Duration(days: 365))),
      Sqlite3EntityFieldBase('dateCreated', DbType.datetime,
...
// Category TABLE
class TableCategory extends Sqlite3EntityTableBase {
  TableCategory() {
    // declare properties of EntityTable
    tableName = 'category';
    primaryKeyName = 'id';
...
// Todo TABLE
class TableTodo extends Sqlite3EntityTableBase {
  TableTodo() {
    // declare properties of EntityTable
    tableName = 'todos';
    primaryKeyName = 'id';
    ...
    // declare fields
    fields = [
      Sqlite3EntityFieldBase('userId', DbType.integer, isIndex: true),
      Sqlite3EntityFieldBase('title', DbType.text),
      Sqlite3EntityFieldBase('completed', DbType.bool, defaultValue: false),
      Sqlite3EntityFieldBase('dateCreated', DbType.datetime,
          defaultValue: DateTime.now(), minValue: DateTime.parse('1900-01-01')),
    ];
    super.init();
...
// BEGIN SEQUENCES
// identity SEQUENCE
class SequenceIdentitySequence extends Sqlite3EntitySequenceBase {
...
class MyDbModel extends Sqlite3EntityModelProvider {
  MyDbModel() {
...
// RELATIONSHIPS (Product)
  ...
  Future<int?> save({bool ignoreBatch = true}) async {
    if (id == null || id == 0) {
      ...
      // id= await _upsert(); // removed in sqlite3_entity_gen 1.3.0+6
...
class ProductManager extends Sqlite3EntityProvider {
  ProductManager()
      : super(MyDbModel(),
...
class CategoryManager extends Sqlite3EntityProvider {
  CategoryManager()
      : super(MyDbModel(),
            tableName: _tableName,
            primaryKeyList: _primaryKeyList,
...
//region TodoManager
class TodoManager extends Sqlite3EntityProvider {
  TodoManager()
      : super(MyDbModel(),
            tableName: _tableName,
            primaryKeyList: _primaryKeyList,
...
class MyDbModelSequenceManager extends Sqlite3EntityProvider {

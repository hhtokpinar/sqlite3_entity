part of 'sqlite3_entity_gen.dart';
...
class Sqlite3EntityBuilder {
  const Sqlite3EntityBuilder(this.model);
  final Sqlite3EntityModel model;
}

class Sqlite3EntityTable {
  ...
  final List<Sqlite3EntityField>? fields;
...
class TableCollection {
  ...
  final Sqlite3EntityTable childTable;
  final Sqlite3EntityFieldRelationship childTableField;
}

class Sqlite3EntitySequence {
  ...
  /// ```
  ///   const mySequence = Sqlite3EntitySequence(
...
class Sqlite3EntityField {
  ...
  final Sqlite3EntitySequence? sequencedBy;
...
/// ```
class Sqlite3EntityFieldVirtual implements Sqlite3EntityField {
  const Sqlite3EntityFieldVirtual(this.fieldName, this.dbType);
  ...
  /// this property is always null in virtual fields
  @override
  Sqlite3EntitySequence? get sequencedBy => null;
...
class Sqlite3EntityFieldRelationship implements Sqlite3EntityField {
  ...
  ///         ),
  /// ```
  const Sqlite3EntityFieldRelationship({
    this.parentTable,
    this.deleteRule,
    this.fieldName,
    this.isPrimaryKeyField,
  ...
  final Sqlite3EntityTable? parentTable;
...
class Sqlite3EntityModel {
  ...
  /// Add tables that you defined as Sqlite3EntityTable const into
  final List<Sqlite3EntityTable>? databaseTables;

  /// Add tables that you want to generate its add/update forms and list views (Optional)
  final List<Sqlite3EntityTable>? formTables;

  /// Add sequences that you defined as Sqlite3EntitySequence const into
  final List<Sqlite3EntitySequence>? sequences;
  ...
  final List<Sqlite3EntityField>? defaultColumns;
...
class ConvertedModel extends Sqlite3EntityModelBase {}

/// To get the generated class from the clipboard instead of running build command
///
/// to see example:
///
/// check createSqlite3EntityModelString() method in example -> https://github.com/hhtokpinar/sqfEntity/blob/master/example/lib/main.dart
class Sqlite3EntityModelConverter {
  Sqlite3EntityModelConverter(this.model);
  final Sqlite3EntityModel model;

  /// Convert defined constant model into Sqlite3EntityModelBase
  Sqlite3EntityModelBase toModelBase() {
  ...
  /// Convert defined constant tables into List<Sqlite3EntityTableBase>
  List<Sqlite3EntityTableBase>? toTables() {
    if (model.databaseTables == null) {
      return null;
    }
    final tables = <Sqlite3EntityTableBase>[];
  ...
  /// Convert defined constant tables into Sqlite3EntityTableBase
  Sqlite3EntityTableBase toTable(Sqlite3EntityTable table) {
    return Sqlite3EntityTableBase()
  ...
  /// Convert defined constant tables into Sqlite3EntityFieldType
  List<Sqlite3EntityFieldType>? toFields(Sqlite3EntityTable table) {
    if (table.fields == null) {
      return null;
    }
    final fields = <Sqlite3EntityFieldType>[];
    for (final field in table.fields!) {
      Sqlite3EntityFieldType _field;
      if (field is Sqlite3EntityFieldRelationship) {
        _field = Sqlite3EntityFieldRelationshipBase(
        ...
        _field = Sqlite3EntityFieldBase(field.fieldName!, field.dbType!);
        getFieldProperties(field, _field);
      }
      fields.add(_field);
    }
  ...
  Sqlite3EntityFieldType getFieldProperties(
      Sqlite3EntityField field, Sqlite3EntityFieldType toField) {
    return toField
  ...
  /// Convert defined constant sequences into List<Sqlite3EntitySequenceBase>
  List<Sqlite3EntitySequenceBase>? toSequences() {
    print('toSequences begin');
    if (model.sequences == null) {
      return null;
    }
    final sequenceList = <Sqlite3EntitySequenceBase>[];
  ...
  /// Convert sent constant sequences into Sqlite3EntitySequenceBase
  Sqlite3EntitySequenceBase? toSequence(Sqlite3EntitySequence? seq) {
    if (seq == null) {
      return null;
    } else {
      final retVal = Sqlite3EntitySequenceBase()
...
class Sqlite3EntityFieldBuilder {
  Sqlite3EntityFieldBuilder(this._table);
  final Sqlite3EntityTableBase _table;
...
''');
    ...
    for (Sqlite3EntityFieldType field
        in _table.fields!.where((f) => !f.fieldName!.startsWith('_'))) {
      if (field is Sqlite3EntityFieldVirtualBase ||
          (field is Sqlite3EntityFieldRelationshipBase &&
...
class Sqlite3EntityControllerBuilder {
  Sqlite3EntityControllerBuilder(this.table, this.formTables);
  final Sqlite3EntityTableBase table;
  final List<Sqlite3EntityTableBase> formTables;
...
''';
  ...
  String __gotoEditgetByIdParameters(Sqlite3EntityTableBase _table) {
...
class Sqlite3EntityObjectBuilder {
  Sqlite3EntityObjectBuilder(this._table);
  final Sqlite3EntityTableBase _table;
  ...
  class ${_table.modelName} extends TableBase ${_table.abstractModelName != null ? 'implements ${_table.abstractModelName}' : ''} {
    ...
    ${_table.customCode != null ? _table.customCode : '''/*
      you can define customCode property of your Sqlite3EntityTable constant. For example:
  ...
  String __createProperties() {
    ...
    for (final field in _table.fields!) {
      if (field is Sqlite3EntityFieldRelationshipBase) {
...
//print('__createBaseConstructure for ${_table.tableName}');
  ...
  String __createConstructureArgs(bool withId) {
    ...
    for (var i = 0; i < _table.fields!.length; i++) {
      //if (_table.fields![i] is Sqlite3EntityFieldVirtualBase) continue;
      if (_table.fields![i] is Sqlite3EntityFieldVirtualBase
          // ||
      ...
      if (_table.fields![i] is Sqlite3EntityFieldRelationshipBase) {
        final Sqlite3EntityFieldRelationshipBase field =
            _table.fields![i] as Sqlite3EntityFieldRelationshipBase;
        if ((field.relationType == RelationType.MANY_TO_MANY &&
                _table.relationType != RelationType.MANY_TO_MANY)
...
//print('end __createDefaultValues for ${_table.tableName}');
  ...
  String __createObjectRelations() {
    ...
    for (final field
        in _table.fields!.whereType<Sqlite3EntityFieldRelationshipBase>()) {
    ...
    for (var tableCollection in _table.collections!) {
      ...
      if (tableCollection.relationType == RelationType.MANY_TO_MANY) {
        ...
        final String? childTablePrimaryKeyName = tableCollection
            ...
            .whereType<Sqlite3EntityFieldRelationshipBase>()
            .firstWhere((f) =>
  ...
  String __saveMethod() {
    ...
    Future<int?> ${_hiddenMethod}saveOrThrow({bool ignoreBatch = true}) async {
      if (${_table.primaryKeyNames[0]} == null || ${_table.primaryKeyNames[0]} == 0 ${_table.primaryKeyType != PrimaryKeyType.integer_auto_incremental || _table.primaryKeyName == null || _table.primaryKeyName!.isEmpty ? '|| !isSaved!' : ''}) {
        ...
        // ${_table.primaryKeyNames[0]}= await _upsert(); // removed in sqlite3_entity_gen 1.3.0+6
...
String __createObjectRelationsPreLoad(Sqlite3EntityTableBase _table) {
...
String __getByIdParameters(Sqlite3EntityTableBase _table, bool withTypes) {
...
String __getByIdWhereStr(Sqlite3EntityTableBase _table) {
  if (_table.primaryKeyNames.isEmpty) {
    return '';
  }
...
// String __getUpdateStr(Sqlite3EntityTableBase _table) {
//   final retVal = StringBuffer();
//   for (final field in _table.fields!) {
...
String __toOnetoOneCollections(Sqlite3EntityTableBase _table) {
  if (_table.collections == null) {
    return '';
  }
  final retVal = StringBuffer();
...
String __toOnetoManyCollections(Sqlite3EntityTableBase _table) {
  if (_table.collections == null) {
    return '';
  }
  final retVal = StringBuffer();
...
String __toOnetoOneSaveCode(Sqlite3EntityTableBase _table) {
  if (_table.collections == null) {
    return '';
  }
  final retVal = StringBuffer();
...
String __toOnetoOneSaveAsCode(Sqlite3EntityTableBase _table) {
  if (_table.collections == null) {
    return '';
  }
  final retVal = StringBuffer();
...
class Sqlite3EntityObjectManagerBuilder {
  Sqlite3EntityObjectManagerBuilder(this._table);
  final Sqlite3EntityTableBase _table;

  @override
  String toString() {
    final String toString = '''//region ${_table.modelName}Manager
class ${_table.modelName}Manager extends Sqlite3EntityProvider {
...
class Sqlite3EntitySequenceBuilder {
  Sqlite3EntitySequenceBuilder(this.sequence, this.modelName);
  Sqlite3EntitySequenceBase sequence;
  String modelName;
  @override
  String toString() {
    return '''
...
class Sqlite3EntityObjectField {
  Sqlite3EntityObjectField(this._table);
  final Sqlite3EntityTableBase _table;
  @override
  String toString() {
...
class Sqlite3EntityObjectFilterBuilder {
  Sqlite3EntityObjectFilterBuilder(this._table, this._isFormTable);
  final Sqlite3EntityTableBase _table;
...
return _${_table.primaryKeyNames[0]} = _setField(_${_table.primaryKeyNames[0]}, '${_table.primaryKeyNames[0]}', ${DbType.integer.toString()});
    ...
    for (Sqlite3EntityFieldType field in _table.fields!) {
      if (field is Sqlite3EntityFieldVirtualBase ||
          (field is Sqlite3EntityFieldRelationshipBase &&
              field.relationType == RelationType.MANY_TO_MANY &&
              _table.relationType != RelationType.MANY_TO_MANY)) {
...
String getUpdateValue(Sqlite3EntityFieldType field, DeleteRule rule) {
  switch (rule) {
    case DeleteRule.SET_DEFAULT_VALUE:
...
String getDefaultValue(Sqlite3EntityFieldType newField) {
...
String toSqliteAddColumnString(Sqlite3EntityFieldType field) {
  String _dbType;
  switch (field.dbType) {
    case DbType.bool:
      _dbType = 'numeric';
...
class TableCollectionBase {
  ...
  Sqlite3EntityTableBase childTable;
  Sqlite3EntityFieldRelationshipBase childTableField;
  RelationType? relationType;
  //Sqlite3EntityTableBase many2ManyTable;
}
...
class Sqlite3EntityTableBase {
  String? tableName = '';
  String? primaryKeyName;
  List<Sqlite3EntityFieldType>? fields;
  ...
  void init() {
    ...
    final List<Sqlite3EntityFieldType> _addRelatedFields = <Sqlite3EntityFieldType>[];
    for (final field in fields!) {
      ...
      if (field is Sqlite3EntityFieldRelationshipBase) {
        ...
        field.table!.fields!
            ...
            .forEach((f) {
          _primaryKeyIndex++;
          final newField = Sqlite3EntityFieldBase(
    ...
    //print(    '>>>>>>>>>>>>>>>>>>>>>>>>>>>> Sqlite3EntityTableBase of [$tableName](${primaryKeyNames.join(',')}) init() successfully');
  }
  ...
  String _createTableSQL({bool createForeignKeys = true}) {
    ...
    for (Sqlite3EntityFieldType field in fields!) {
      if (field is! Sqlite3EntityFieldVirtualBase) {
    ...
    for (Sqlite3EntityFieldType field in fields!) {
      ...
      if (field is Sqlite3EntityFieldRelationshipBase && createForeignKeys) {
  ...
  String __createConstructure(bool isQuery, bool withId) {
    ...
    for (int i = 0; i < fields!.length; i++) {
      if (fields![i] is Sqlite3EntityFieldVirtualBase
          // ||
      ...
      if (fields![i] is Sqlite3EntityFieldRelationshipBase) {
        final Sqlite3EntityFieldRelationshipBase field =
            fields![i] as Sqlite3EntityFieldRelationshipBase;
        if (field.relationType == RelationType.MANY_TO_MANY &&
            relationType != RelationType.MANY_TO_MANY) {
          continue;
        }
...
class Sqlite3EntitySequenceBase {
  /// Name of the sequence.
  String? sequenceName;
  ...
  bool initialized = false;
  Sqlite3EntitySequenceBase init() {
    cycle = cycle ?? false;
    ...
    //print('>>>>>>>>>>>>>>>>>>>>>>>>>>>> Sqlite3EntitySequenceBase of [$sequenceName] initialized successfully');
    return this;
  }
...
abstract class Sqlite3EntityFieldType {
  Sqlite3EntityFieldType(this.fieldName, this.dbType,
      {this.defaultValue,
      this.minValue,
      this.maxValue,
      this.table,
  ...
  dynamic minValue;
  dynamic maxValue;
  Sqlite3EntityTableBase? table;
  Sqlite3EntitySequenceBase? sequencedBy;
...
class Sqlite3EntityFieldBase implements Sqlite3EntityFieldType {
  @override
  Sqlite3EntityFieldBase(this.fieldName, this.dbType,
      {this.defaultValue,
      this.minValue,
      this.maxValue,
      this.table,
...
class Sqlite3EntityFieldVirtualBase implements Sqlite3EntityFieldType {
  Sqlite3EntityFieldVirtualBase(this.fieldName, this.dbType);
...
class Sqlite3EntityFieldPrivateClassBase implements Sqlite3EntityFieldType {
  @override
  String? checkCondition;
...
class Sqlite3EntityFieldRelationshipBase implements Sqlite3EntityFieldType {
  Sqlite3EntityFieldRelationshipBase(this.table, this.deleteRule,
      {this.fieldName,
      this.defaultValue,
      this.isPrimaryKeyField,
      this.minValue,
  ...
  Sqlite3EntityFieldRelationshipBase init() {
    if (table != null) {
      ...
      //print('Sqlite3EntityFieldRelationshipBase constructor: table = null: fieldName=$fieldName');
    }
    return this;
  }
  ...
  @override
  Sqlite3EntitySequenceBase? sequencedBy;
  final List<Sqlite3EntityFieldType> relationshipFields = <Sqlite3EntityFieldType>[];
  String? manyToManyTableName;
  Sqlite3EntityTableBase? manyToManyTable;
...
abstract class Sqlite3EntityModelBase {
  String? modelName;
  String? databaseName;
  ...
  int? dbVersion;
  List<Sqlite3EntityTableBase>? databaseTables;
  List<Sqlite3EntityTableBase>? formTables;
  List<Sqlite3EntitySequenceBase>? sequences;
  ...
  // List<Sqlite3EntityFieldType>? defaultColumns;

  void init() {
    dbVersion = dbVersion ?? 1;
    final manyToManyTables = <Sqlite3EntityTableBase>[];
    ...
    for (final table in databaseTables!) {
      ...
      for (final field
          in table.fields!.whereType<Sqlite3EntityFieldRelationshipBase>()) {
        // if (field.relationType == RelationType.ONE_TO_MANY_VICEVERSA) {
        //   field.relationType = RelationType.ONE_TO_MANY;
        //   databaseTables!
        //       .singleWhere((t) => t.tableName == field.table!.tableName!)
        //     ..fields!.add(Sqlite3EntityFieldRelationshipBase(
        ...
        if (field.relationType == RelationType.MANY_TO_MANY) {
          ...
          if (many2manyTableExist.isNotEmpty) {
            ...
            many2manyTable = Sqlite3EntityTableBase()
              ...
              ..fields = [
                Sqlite3EntityFieldRelationshipBase(table, field.deleteRule,
                    ...
                    relationType: RelationType.ONE_TO_MANY),
                Sqlite3EntityFieldRelationshipBase(field.table, field.deleteRule,
                    fieldName: table.primaryKeyNames[0] ==
                            field.table!.primaryKeyNames[0]
          ...
          if (databaseTables!.length > 1) {
            if (field.table!.fields!
                .where((f) =>
                    f is Sqlite3EntityFieldRelationshipBase &&
...
List<TableCollectionBase> _getCollections(
    Sqlite3EntityTableBase table, Sqlite3EntityModelBase _m) {

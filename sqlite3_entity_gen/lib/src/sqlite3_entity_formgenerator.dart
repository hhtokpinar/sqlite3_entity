...
class Sqlite3EntityFormGenerator
    extends GeneratorForAnnotation<Sqlite3EntityBuilder> {
  @override
  String? generateForAnnotatedElement(
    ...
    var instanceName =
        'Sqlite3EntityTable'; //        element.toString().replaceAll('Sqlite3EntityTable', '').trim();
    ...
    for (final table in dbModel.formTables!) {
      ...
      modelStr.writeln(Sqlite3EntityFormConverter(table).toFormWidgetsCode());
    }
    //..writeln('*/') //  write output as commented to see what is wrong

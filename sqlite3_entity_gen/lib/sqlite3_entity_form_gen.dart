...
class Sqlite3EntityFormConverter {
  Sqlite3EntityFormConverter(this.table);
...
''';
  ...
  String toFormBuildRowWidgets(Sqlite3EntityTableBase table) {
    ...
    for (final field in table.fields!.where((f) => f.sequencedBy == null)) {
      ...
      if (field is Sqlite3EntityFieldRelationshipBase &&
        ...
        retVal.writeln('buildRow$ccName(onChangeDropdownItemFor$ccName),');
          ...
          field is! Sqlite3EntityFieldVirtualBase) {
  ...
  String toFormSaveCodeDateTimeVariables(Sqlite3EntityTableBase table) {
  ...
  String toFormSaveCode(Sqlite3EntityTableBase table) {
    // print('toFormWidgetsCode begin 9: tableName:${table.tableName}');
    final retVal = StringBuffer();
    if (table.primaryKeyName!.isNotEmpty &&
        table.primaryKeyType != PrimaryKeyType.integer_auto_incremental) {
      retVal.writeln(toFieldSaveCode(Sqlite3EntityFieldBase(
  ...
  String toFieldSaveCode(Sqlite3EntityFieldType field) {
    final ccName = toCamelCase(field.fieldName);
    if (field is Sqlite3EntityFieldRelationshipBase &&
        field.relationType == RelationType.ONE_TO_MANY) {
  ...
  String toFormBuildRowCodeTable(Sqlite3EntityTableBase table) {
    // print('toFormWidgetsCode begin 7: tableName:${table.tableName}');
    final retVal = StringBuffer();
    if (table.primaryKeyName!.isNotEmpty &&
        table.primaryKeyType != PrimaryKeyType.integer_auto_incremental) {
      retVal.writeln(toFormBuildRowCodeField(Sqlite3EntityFieldBase(
          table.primaryKeyName,
          table.primaryKeyType == PrimaryKeyType.text
              ? DbType.text
              : DbType.integer,
  ...
  String toFormDeclarationCodeTable(Sqlite3EntityTableBase table) {
    // print('toFormWidgetsCode begin 3: tableName:${table.tableName}');
    final retVal = StringBuffer();
    if (table.primaryKeyNames.isNotEmpty &&
        table.primaryKeyType != PrimaryKeyType.integer_auto_incremental) {
      retVal.writeln(toFormDeclarationCodeField(Sqlite3EntityFieldBase(
          table.primaryKeyName,
          table.primaryKeyType == PrimaryKeyType.text
              ? DbType.text
              : DbType.integer,
  ...
  String toFormInitStateCodeTable(Sqlite3EntityTableBase table) {
  ...
  String toFormDeclarationCodeField(Sqlite3EntityFieldType field) {
  ...
  String toFormInitStateCodeField(Sqlite3EntityFieldType field) {
  ...
  String toFormBuildDropDownCodeTable(Sqlite3EntityTableBase table) {
  ...
  String toFormBuildDropDownCodeField(Sqlite3EntityFieldRelationshipBase field) {
    final ccName = toCamelCase(field.fieldName);
  ...
  String toFormBuildRowCodeField(Sqlite3EntityFieldType field) {
...
String getformListTitleField(Sqlite3EntityTableBase table) {
  String fieldName = '';
...
String getformListSubTitleField(Sqlite3EntityTableBase table) {
  String fieldName = '';
  ...
  if (table.formListSubTitleField != null) {
    ...
    if (fieldName.isEmpty) {
      for (final field in table.fields!.where((f) =>
          f is! Sqlite3EntityFieldVirtualBase &&
